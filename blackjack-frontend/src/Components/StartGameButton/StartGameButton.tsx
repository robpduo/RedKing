...
import { getDealDealer, getDealPlayer, getDeck, initializeDeck } from '../../Slices/DeckSlice';
    ...
    <>
     {gameStatus.includes("Game not initialized") ?
          <div className="start-game-btn-container">
            { <button className="start-game-btn" onClick={handleGameInit}>Start Game</button> }
          </div> : <></>
        }
    </>
  )
